...
SSD1306::SSD1306(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS) : GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
  cs = CS;
  rst = RST;
  dc = DC;
  sclk = SCLK;
...
SSD1306::SSD1306(int8_t DC, int8_t RST, int8_t CS) : GFX(SSD1306_LCDWIDTH, SSD1306_LCDHEIGHT) {
  dc = DC;
  rst = RST;
  cs = CS;
  hwSPI = true;
